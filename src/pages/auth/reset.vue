<template>
  <view
    ...
    <text class="mt-60 color-title fs-36 fw-600 lh-100">重置密码</text>
    ...
    <view :style="{ padding: `30rpx`, borderTop: `2rpx #ececec solid` }">
      ...
      <view class="fd-row ai-center mt-44">
        ...
        <uni-easyinput class="f1" type="number" placeholder="验证码" />
      ...
      <label class="mt-44">
        <uni-icons class="mr-30" type="locked-filled" size="18" color="#fff" />
        <uni-easyinput class="f1" type="password" placeholder="新密码" />
      </label>
      <label class="mt-44">
        <uni-icons class="mr-30" type="locked-filled" size="18" color="#fff" />
      ...
      <view class="fd-row">
        <button type="primary" class="border-none fs-32 f1 bgc-2 mt-90 lh-66 color-inverse" hover-class="tap-hover">
          重置
        </button>
