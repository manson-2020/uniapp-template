<template>
  <view class="root">
    ...
    <button v-if="userInfo" class="btn-authorization" type="primary" lang="zh_CN" @click="getUserInfo">
      授权信息
    </button>

    <button v-else class="btn-authorization" type="primary" lang="zh_CN" @getphonenumber="authorization"
